...
describe('testCommenting', () => {
    ...
    it('user can make comment and like comment on post', () => {
        ...
        cy.findByTestId('AddCircleOutlineIcon').click();
            ...
            const postTitle = 'postTestDisike title';
            const postDescription = 'postTestDisike description'
            const postContent = 'postTestDisike content'
            const postTags = 'postDisike, postDisike, postDisike'
